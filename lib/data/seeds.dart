...
class Seeds {
  ...
  static final _films = [
    Film(name: 'Kodak Portra 160', brand: 'Kodak', iso: 160, format: '35mm'),
    Film(name: 'Kodak Portra 400', brand: 'Kodak', iso: 400, format: '35mm'),
    Film(name: 'Kodak Portra 800', brand: 'Kodak', iso: 800, format: '35mm'),
    Film(name: 'Kodak Ektar 100', brand: 'Kodak', iso: 100, format: '35mm'),
    Film(name: 'Kodak Gold 200', brand: 'Kodak', iso: 200, format: '35mm'),
    Film(name: 'Kodak ColorPlus 200', brand: 'Kodak', iso: 200, format: '35mm'),
    Film(name: 'Kodak UltraMax 400', brand: 'Kodak', iso: 400, format: '35mm'),
    Film(name: 'Kodak Tri-X 400', brand: 'Kodak', iso: 400, format: '35mm'),
    Film(name: 'Kodak T-Max 100', brand: 'Kodak', iso: 100, format: '35mm'),
    Film(name: 'Kodak T-Max 400', brand: 'Kodak', iso: 400, format: '35mm'),
    Film(name: 'Kodak Ektachrome E100', brand: 'Kodak', iso: 100, format: '35mm'),
    Film(name: 'Fujifilm Superia 400', brand: 'Fujifilm', iso: 400, format: '35mm'),
    Film(name: 'Fujifilm Velvia 50', brand: 'Fujifilm', iso: 50, format: '35mm'),
    Film(name: 'Fujifilm Velvia 100', brand: 'Fujifilm', iso: 100, format: '35mm'),
    Film(name: 'Fujifilm Provia 100F', brand: 'Fujifilm', iso: 100, format: '35mm'),
    Film(name: 'Fujifilm Acros 100 II', brand: 'Fujifilm', iso: 100, format: '35mm'),
    Film(name: 'Ilford HP5 Plus 400', brand: 'Ilford', iso: 400, format: '35mm'),
    Film(name: 'Ilford Delta 100', brand: 'Ilford', iso: 100, format: '35mm'),
    Film(name: 'Ilford Delta 400', brand: 'Ilford', iso: 400, format: '35mm'),
    Film(name: 'Ilford FP4 Plus 125', brand: 'Ilford', iso: 125, format: '35mm'),
    Film(name: 'Ilford XP2 Super 400', brand: 'Ilford', iso: 400, format: '35mm'),
    Film(name: 'Cinestill 400D', brand: 'Cinestill', iso: 400, format: '35mm'),
    Film(name: 'Cinestill 800T', brand: 'Cinestill', iso: 800, format: '35mm'),
    Film(name: 'Cinestill 50D', brand: 'Cinestill', iso: 50, format: '35mm'),
    Film(name: 'Lomography Color 400', brand: 'Lomography', iso: 400, format: '35mm'),
  ];
